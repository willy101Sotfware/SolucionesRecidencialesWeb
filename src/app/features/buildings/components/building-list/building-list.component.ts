...
@Component({
  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        ...
        <a routerLink="/buildings/new" class="btn btn-primary"><span>+ Nuevo Edificio</span></a>
      </div>
      ...
      <div class="table-container" *ngIf="!isLoading">
        <div class="table-scroll">
          <table class="data-table">
            <thead>
              <tr>
                <th>Nombre</th><th>Ciudad</th><th>Dirección</th><th>Empresa</th><th>Estado</th><th>Acciones</th>
              </tr>
            </thead>
            <tbody>
  ...
  styles: [`
    ...
    .btn { padding: 10px 20px; border-radius: 6px; text-decoration: none; cursor: pointer; border: none; font-size: 0.9rem; transition: all 0.3s; display: inline-flex; align-items: center; white-space: nowrap; }
...
export class BuildingListComponent implements OnInit {
  ...
  loadBuildings(): void {
    ...
    this.buildingService.getAll().subscribe({
      ...
      error: (error: unknown) => { this.isLoading = false; this.errorMessage = 'Error al cargar los edificios.'; this.cdr.detectChanges(); console.error(error); }
    });
  }
