      ...
      <div class="table-container" *ngIf="!isLoading">
        <div class="table-scroll">
          <table class="data-table">
            <thead>
              <tr>
                <th>Documento</th><th>Nombre</th><th>Email</th><th>Teléfono</th><th>Edificio</th><th>Estado</th><th>Acciones</th>
              </tr>
            </thead>
            <tbody>
...
export class EmployeeListComponent implements OnInit {
  ...
  loadEmployees(): void {
    ...
    this.employeeService.getAll().subscribe({
      next: (data: EmployeeResponse[]) => { this.employees = data; this.isLoading = false; this.cdr.detectChanges(); },
      error: (error: unknown) => { this.isLoading = false; this.errorMessage = 'Error al cargar los empleados.'; this.cdr.detectChanges(); console.error(error); }
    });
  }
